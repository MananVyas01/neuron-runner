...
class Powerup(pygame.sprite.Sprite):
    def __init__(self, powerup_type, x_pos, speed_multiplier=1.0):
        ...
        self.create_sprite()
        self.rect.x = x_pos
        self.rect.y = GROUND_Y - self.rect.height - random.randint(0, 100)  # Vary height
    ...
    def create_sprite(self):
        ...
        if self.type == 'DATASET':
            ...
            for i in range(5):
                y_pos = 18 + i * 6
                pygame.draw.line(self.image, COLORS['WHITE'], (12, y_pos), (38, y_pos), 2)
            
            # Corner fold
            pygame.draw.polygon(self.image, COLORS['WHITE'], [(32, 8), (42, 18), (32, 18)])
            ...
            connections = [
                ...
                (nodes[1], nodes[4]), (nodes[2], nodes[5])
            ]
    ...
    def update(self):
        ...
        # Floating animation
        float_amplitude = 5
        self.rect.y = self.base_y + math.sin(self.animation_timer * 0.1 + self.float_offset) * float_amplitude
