...
class Obstacle(pygame.sprite.Sprite):
    ...
    def create_sprite(self):
        ...
        if self.type == 'OVERFITTING':
            ...
            # Main crystal body
            main_points = [(40, 10), (65, 30), (70, 60), (50, 85), (40, 95), (30, 85), (10, 60), (15, 30)]
...
class ObstacleManager:
    ...
    def update(self, difficulty_multiplier, game_score):
        ...
        self.current_speed_multiplier = min(OBSTACLE_MAX_SPEED / OBSTACLE_BASE_SPEED, self.current_speed_multiplier)
    ...
    def spawn_spike_pattern(self):
        ...
        if pattern_type == 'wave':
            ...
            for i in range(3):
                ...
                obstacle = Obstacle(obstacle_type, x_pos, self.current_speed_multiplier * 1.2)
            ...
            for i, obs_type in enumerate(obstacle_types):
                ...
                obstacle = Obstacle(obs_type, x_pos, self.current_speed_multiplier * 1.1)
                self.obstacles.add(obstacle)
        
        elif pattern_type == 'speed_burst':
            # Single fast obstacle
            obstacle_type = random.choice(list(OBSTACLE_TYPES.keys()))
            obstacle = Obstacle(obstacle_type, SCREEN_WIDTH + 50, self.current_speed_multiplier * 1.5)
            self.obstacles.add(obstacle)
    ...
    def spawn_obstacle(self):
        ...
        if random.random() < group_chance:
            ...
            for i in range(group_size):
                ...
                obstacle = Obstacle(obstacle_type, obstacle_x, self.current_speed_multiplier)
                self.obstacles.add(obstacle)
        else:
            # Single obstacle
            obstacle_type = random.choice(obstacle_types)
    ...
    def is_close_call(self, obstacle, player):
        ...
        if (obstacle.rect.right >= player.rect.left - 10 and 
            obstacle.rect.right <= player.rect.left + 5):
